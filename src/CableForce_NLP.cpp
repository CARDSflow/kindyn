...
#include "kindyn/CableForce_NLP.hpp"
...
bool CableForce_NLP::get_nlp_info(
        Index&          n,
        Index&          m,
        Index&          nnz_jac_g,
        Index&          nnz_h_lag,
...
bool CableForce_NLP::get_bounds_info(
        Index   n,
        Number* x_l,
        Number* x_u,
        Index   m,
...
bool CableForce_NLP::get_starting_point(
        Index   n,
        bool    init_x,
        Number* x,
        bool    init_z,
...
bool CableForce_NLP::eval_grad_f(
        Index         n,
        const Number* x,
        bool          new_x,
        Number*       grad_f
...
bool CableForce_NLP::eval_jac_g(
        Index         n,
        const Number* x,
        bool          new_x,
        Index         m,
...
void CableForce_NLP::finalize_solution(
        SolverReturn               status,
        Index                      n,
        const Number*              x,
        const Number*              z_L,
