...
def main():
    ...
    for pointIter in range(num_requested_points):
        ...
        jointAngleResult_right = inverse_kinematics_client(endeffector_right, frame_right_1, thisX + BIKE_OFFSET_X,
        ...
        jointAngleResult_left = inverse_kinematics_client(endeffector_left, frame_left_1, thisX + BIKE_OFFSET_X,
