...
class RoboyCIIE: public cardsflow::vrpuppet::Robot{
public:
    /**
     * Constructor
     ...
     */
    RoboyCIIE(string urdf, string cardsflow_xml){
        ...
        motor_status_sub = nh->subscribe("roboy/middleware/MotorStatus",1,&RoboyCIIE::MotorStatus, this);
        init_pose = nh->advertiseService("init_pose",&RoboyCIIE::initPose,this);
...
int main(int argc, char *argv[]) {
    ...
    RoboyCIIE robot(urdf, cardsflow_xml);
