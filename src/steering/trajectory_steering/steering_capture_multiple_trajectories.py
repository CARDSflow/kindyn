...
def main():
    ...
    for pointMultiplicityIterator in range(1, POINT_MULTIPLICITY + 1):
        for pointIter in range(1, NUM_STEERING_ANGLES + 1):
            ...
            jointAngleResult_left = inverse_kinematics_client(ENDEFFECTOR_LEFT, FRAME_LEFT, thisLeftHandX,
                                                              thisLeftHandY, thisLeftHandZ, thisRoll, thisPitch,
            ...
            if jointAngleResult_right and jointAngleResult_left:
                ...
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)][
                    "Steering_angle"] = thisSteeringAngle
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][
                    JOINT_SHOULDER_AXIS0_LEFT] = jointAngleResult_left[JOINT_SHOULDER_AXIS0_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][
                    JOINT_SHOULDER_AXIS1_LEFT] = jointAngleResult_left[JOINT_SHOULDER_AXIS1_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][
                    JOINT_SHOULDER_AXIS2_LEFT] = jointAngleResult_left[JOINT_SHOULDER_AXIS2_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][JOINT_ELBOW_ROT0_LEFT] = \
                jointAngleResult_left[JOINT_ELBOW_ROT0_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][JOINT_ELBOW_ROT1_LEFT] = \
                jointAngleResult_left[JOINT_ELBOW_ROT1_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][JOINT_WRIST_0_LEFT] = \
                jointAngleResult_left[JOINT_WRIST_0_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][JOINT_WRIST_1_LEFT] = \
                jointAngleResult_left[JOINT_WRIST_1_LEFT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][
                    JOINT_SHOULDER_AXIS0_RIGHT] = jointAngleResult_right[JOINT_SHOULDER_AXIS0_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][
                    JOINT_SHOULDER_AXIS1_RIGHT] = jointAngleResult_right[JOINT_SHOULDER_AXIS1_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][
                    JOINT_SHOULDER_AXIS2_RIGHT] = jointAngleResult_right[JOINT_SHOULDER_AXIS2_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][JOINT_ELBOW_ROT0_RIGHT] = \
                jointAngleResult_right[JOINT_ELBOW_ROT0_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][JOINT_ELBOW_ROT1_RIGHT] = \
                jointAngleResult_right[JOINT_ELBOW_ROT1_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][JOINT_WRIST_0_RIGHT] = \
                jointAngleResult_right[JOINT_WRIST_0_RIGHT]
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][JOINT_WRIST_1_RIGHT] = \
                jointAngleResult_right[JOINT_WRIST_1_RIGHT]
                ...
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Right"][
                    "Hand_actual"] = getPositionRightHand()
                jointAngleDict["point_" + str(pointIter * pointMultiplicityIterator)]["Left"][
                    "Hand_actual"] = getPositionLeftHand()
                print("Moving on...")
